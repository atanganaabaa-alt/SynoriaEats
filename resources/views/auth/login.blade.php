<x-guest-layout>
    <div class="mb-6">
        <a href="{{ route('google.redirect') }}"
           class="flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:bg-slate-800 dark:border-slate-600 dark:text-gray-100 dark:hover:bg-slate-700">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                ...
                <span class="ms-2 text-sm text-gray-600 dark:text-gray-300">{{ __('Se souvenir de moi') }}</span>
            </label>
        </div>
